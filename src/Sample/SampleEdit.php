<?php
namespace Water\Vular\Order\Sample;
...
use Water\Vular\Order\Models\Customer;
use Water\Vular\Order\Models\Supplier;

class SampleEdit extends OneColumnFormPage{

    protected $modelClass = \Water\Vular\Order\Models\Sample::class;
